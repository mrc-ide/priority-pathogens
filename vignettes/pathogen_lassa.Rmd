...
```{r Figure_3A, echo=FALSE, fig.height=6, fig.width=9, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r Figure_3D, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE,fig.height=7, fig.width=9}
...
```{r qa, message=FALSE, fig.height=10, fig.width=8, warning=FALSE, paged.print=FALSE}
quality <- articles %>%
