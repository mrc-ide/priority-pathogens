...
base_filepath <- "https://raw.githubusercontent.com/mrc-ide/epireview/main/inst/extdata"

articles   <- read.csv(file.path(base_filepath, "lassa_articles.csv"))
models     <- read.csv(file.path(base_filepath, "lassa_models.csv"))
outbreaks  <- read.csv(file.path(base_filepath, "lassa_outbreaks.csv"))
parameters <- read.csv(file.path(base_filepath, "lassa_parameters.csv"))
