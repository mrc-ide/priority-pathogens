...
ebola_models_cleaning <- function(df) {
    ...
    mutate(
      ...
      parameter_value_type =
        case_when(
          ...
          parameter_class %in% "Reproduction number" &
            is.na(parameter_value_type) &
            covidence_id %in% 17881 ~ "Median", # Human delays
          parameter_class %in% "Human delay" &
            is.na(parameter_value_type) & covidence_id %in% c(
          ...
          parameter_class %in% "Attack rate" &
            is.na(parameter_value_type) &
            covidence_id %in% c(
              241, 1030, 1053, 2240, 2241, 3052, 4829,
              4991, 5404, 7199, 11467
            ) ~ "Other", # "Rates"
          parameter_class %in% "Attack rate" &
            covidence_id %in% 6472 ~ "Unspecified",
      ...
      attack_rate_type =
        case_when(
          ...
          parameter_class %in% "Attack rate" &
            covidence_id %in% c(
              1053, 1749, 2240, 4253, 4829, 4991, 6472,
              11467, 4796, 5601, 6470, 6471
            ) ~ "Secondary",
          parameter_class %in% "Attack rate" &
            population_sample_type %in% "Household based" &
