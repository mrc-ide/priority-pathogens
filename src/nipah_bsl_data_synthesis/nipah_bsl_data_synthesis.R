...
bsl_model_plot <- ggplot(density_summary, aes(x = x, y = mean, color = model, fill = model)) +
  # Posterior densities
...
ggsave('nipah_incubation_period_bsl_model.pdf', plot=bsl_model_plot, width = 11, height = 7)
