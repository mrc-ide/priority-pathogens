...
risk_table_plt_severe <-  risk_factor_plot(risk_table, "Severe disease",
                                          custom_colours) +
  ggtitle('Severe Disease') + theme(legend.position = "none")
risk_table_plt_recov <-  risk_factor_plot(risk_table, "Recovery",
                                          custom_colours) +
  ggtitle('Recovery') + theme(legend.position = "none")
risk_table_plt_other <-  risk_factor_plot(risk_table, "Other",
                                          custom_colours) +
  ggtitle('Other')

# Everything else
risk_table_plt <- (risk_table_plt_infection  / risk_table_plt_sero / risk_table_plt_recov) |
  ( risk_table_plt_death/ risk_table_plt_severe / risk_table_plt_other) +
  plot_annotation(tag_levels = 'A') + plot_layout(guides = "collect")

##risk_table_plt
left_col  <- risk_table_plt_infection / risk_table_plt_sero/ risk_table_plt_recov
right_col <- risk_table_plt_death / risk_table_plt_severe / risk_table_plt_other

risk_table_plt <- (left_col | right_col) +
  plot_annotation(tag_levels = 'A') +
  plot_layout(guides = "collect", widths = c(1, 1), heights = c(7/15, 1.5, 1.5))

ggsave("figure_SI_risk_panel_all_qa.pdf", plot = risk_table_plt, width = 20, height = 18)
...
ggsave("figure_SI_risk_facet_option_1_all_qa.pdf", plot = rf_facet_o1,
       width = 16, height = 10)
...
ggsave("figure_SI_risk_facet_option_2_all_qa.pdf", plot = rf_facet_o2,
       width = 17, height = 12)
...
ggsave("figure_SI_risk_facet_option_3_all_qa.pdf", plot = rf_facet_o3,
       width = 14, height = 10)
# ------------------------------------------------------------------------------
# *--------------------------------- Option 4 ---------------------------------*
...
ggsave("figure_SI_risk_facet_option_4_all_qa.pdf", plot = rf_facet_o4,
       width = 14, height = 10)
