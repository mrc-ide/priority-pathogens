...
p1 <- forest_plot(
  ...
  sort = TRUE,
  point_size = point_size) + 
  facet_wrap(~delay_label_short,scales="free_y",ncol=1) + ggtitle("Symptoms")#+ 
...
p2 <- forest_plot(
  ...
  sort = TRUE,
  point_size = point_size) + 
  facet_wrap(~delay_label_short,scales="free_y",ncol=1) + ggtitle("Symptoms to care")
...
p3 <- forest_plot(
  ...
  sort = TRUE,
  point_size = point_size) + 
  facet_wrap(~delay_label_short,scales="free_y",ncol=1)+ ggtitle("Care to outcome")
...
p4 <- forest_plot(
  ...
  sort = TRUE,
  point_size = point_size) + 
  facet_wrap(~delay_label_short,scales="free_y",ncol=1) + ggtitle("Recurrence")
...
p5 <- forest_plot(
  ...
  sort = TRUE,
  point_size = point_size) + 
  facet_wrap(~delay_label_short,scales="free_y",ncol=1) + ggtitle("Transmission")
...
cowplot::plot_grid(p1+theme(legend.position = "none"),
                   ...
                   ncol=3,
                   rel_widths = c(1,1,1),rel_heights = c(1.5,1),
                   align="hv")
ggsave("test.png",width=25,height=25)
...
cowplot::plot_grid(p2+theme(legend.position = "none"),
                   ...
                   p4+theme(legend.position = "none"),
                   p5+theme(legend.position = "none"),
                   ncol=1,align="hv",rel_heights = c(3,4,3,1))


c2 <- cowplot::plot_grid(p2+theme(legend.position = "none"),
                   p3+theme(legend.position = "none"),
                   ncol=1,align="hv")

c3 <- cowplot::plot_grid(p4+theme(legend.position = "none"),
                   p5+theme(legend.position = "none"),
                   ncol=1,align="hv",rel_heights = c(3,1))

cowplot::plot_grid(c3,cowplot::get_legend(p1),ncol=1)
...
cowplot::plot_grid(p1+theme(legend.position="none"),
                   c2,
                   cowplot::plot_grid(c3,cowplot::get_legend(p1),ncol=1),
                   ncol=3,rel_widths = c(1.5,1.5,1))
ggsave("test.png",height=20,width=25,bg="white")
