...
parameter_final <- rbind(parameter_single,
  ...
  mutate(Uncertainty = ifelse(parameter_uncertainty_type == 'CI95%', paste0(parameter_uncertainty_lower_value, ", ", parameter_uncertainty_upper_value),
         ...
         population_study_end_month = case_when(covidence_id == '3795' ~ 'Feb',
                                                covidence_id == '2600' ~ 'Dec',
                                                TRUE ~ population_study_end_month),
         population_study_end_year = case_when(covidence_id == '3795' ~ '1975',
                                               covidence_id == '2600' ~ '1981',
         ...
         `Survey year` = ifelse(population_study_start_year == population_study_end_year & !is.na(population_study_start_month) & !is.na(population_study_end_month)& population_study_start_month!=population_study_end_month,
                                ...
                                ifelse(population_study_start_year != population_study_end_year, 
                                       paste0(population_study_start_year,"-", population_study_end_year), 
                                       ifelse(population_study_start_year == population_study_end_year & !is.na(population_study_start_month) & !is.na(population_study_end_month) & population_study_start_month==population_study_end_month,
