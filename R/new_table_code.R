...
articles   <- read.csv("../archive/db_compilation/20240308-170138-c84b75d9/articles.csv",  check.names = FALSE, na.strings = c("", "NA"))
outbreaks  <- read.csv("../archive/db_compilation/20240308-170138-c84b75d9/outbreaks.csv",  check.names = FALSE, na.strings = c("", "NA"))
models     <- read.csv("../archive/db_compilation/20240308-170138-c84b75d9/models.csv",  check.names = FALSE, na.strings = c("", "NA"))
parameters <- read.csv("../archive/db_compilation/20240308-170138-c84b75d9/parameters.csv",  check.names = FALSE, na.strings = c("", "NA"))
...
source('../shared/lassa_functions.R')
...
write.table(outs, file = "lassa/latex_outbreaks.csv", sep = ",", 
...
write.table(mods, file = "lassa/latex_models.csv", sep = ",", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(trns_params, file = "lassa/latex_transmission.csv", sep = ",", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(hdel_params, file = "lassa/latex_delays.csv", sep = ",", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(cfrs_params, file = "lassa/latex_severity.csv", sep = ",", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(sero_params, file = "lassa/latex_seroprevalence.csv", sep = ",", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(risk_params, file = "lassa/latex_riskfactors.csv", sep = ",", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)