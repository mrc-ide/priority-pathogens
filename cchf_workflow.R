...
# Requires:
#   - A REDCap api
#   - cchf_config.yaml.that specifies how to run the task
#     (relative path: src/db_redcap_download/download_config/cchf_config.yaml)
orderly_run("db_redcap_download",list(pathogen="CCHF"))
...
#   - mapping_table.csv
#     (relative path: shared/redcap_data/cchf/mapping_table.csv)
#   - config.yaml that specifies how to run the task
#     (relative path: src/db_extraction_prep/redcap_task/cchf/config.yaml)
orderly_run("db_extraction_prep",list(pathogen="CCHF",
